...
function Card(props) {
  ...
  <div className="container">
    ...
    {props.weatherIcon < 1 ? "" : <img src={props.isDayTime ? `/assets/img/day.png` : `/assets/img/night.png`} 
      className="time card-image-top" alt=""/>}

{/*     <img src={props.isDayTime ? `/assets/img/day.png` : `/assets/img/night.png`} 
      className="time card-image-top" alt=""/> */}

      <div className="icon bg-light mx-auto text-center">
      <img src={props.weatherIcon < 1 ? `/assets/img/meow.png` : `/assets/img/icons/${props.weatherIcon}.svg`} alt="" />
      </div>
